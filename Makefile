...
libpresage.$(SUFFIX): src/c/purple-presage.a src/rust/target/debug/libpurple_presage_backend.a Makefile
	$(CC) -shared -o $@ -static-libgcc -Wl,--whole-archive src/c/purple-presage.a -Wl,--no-whole-archive src/rust/target/debug/libpurple_presage_backend.a -Wl,-Bstatic -lwinpthread -Wl,-Bdynamic $(LDFLAGS)
